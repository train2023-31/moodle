...
/**
 * The fundingtype_created event class.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class fundingtype_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfundingtypecreated', 'local_financeservices');
    }
    ...
    public function get_description() {
        return "The user with id {$this->userid} created a new funding type with id {$this->objectid}. " .
