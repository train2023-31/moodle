 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class clause_hidden extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventclausehidden', 'local_financeservices');
    }
    ...
    public function get_description() {
        return "The user with id {$this->userid} hid the finance clause with id {$this->objectid}. " .
