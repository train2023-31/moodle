...
/**
 * The fundingtype_hidden event class.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class fundingtype_hidden extends \core\event\base {
    ...
    protected function init() {
        $this->data['crud'] = 'd'; // Using delete for hiding since it's a soft delete
    ...
    public static function get_name() {
        return get_string('eventfundingtypehidden', 'local_financeservices');
    }
    ...
    public function get_description() {
        return "The user with id {$this->userid} hid the funding type with id {$this->objectid}. " .
    ...
    public function get_url() {
        return new \moodle_url('/local/financeservices/pages/manage_fundingtypes.php', 
                             array('action' => 'manage'));
    }
