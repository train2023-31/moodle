...
/**
 * The fundingtype_restored event.
 *
...
/**
 * The fundingtype_restored event class.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class fundingtype_restored extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfundingtyperestored', 'local_financeservices');
    }
    ...
    public function get_description() {
        return "The user with id {$this->userid} restored the funding type with id {$this->objectid}. " .
