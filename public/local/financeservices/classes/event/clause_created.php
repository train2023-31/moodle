...
/**
 * The clause_created event class.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class clause_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventclausecreated', 'local_financeservices');
    }
    ...
    public function get_description() {
        ...
        return "The user with id {$this->userid} created a new finance clause with id {$this->objectid}. " .
